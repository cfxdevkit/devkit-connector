...
async function generateTypes(hre: HardhatRuntimeEnvironment) {
  console.log("🔧 Generating TypeScript types for Core contracts...");
...
export const CONTRACT_ADDRESSES = {
  confluxCore: {
    DelegationManager: process.env.CONFLUX_CORE_DELEGATION_MANAGER_ADDRESS || "",
  },
  confluxCoreTestnet: {
    DelegationManager: process.env.CONFLUX_CORE_TESTNET_DELEGATION_MANAGER_ADDRESS || "",
  },
  hardhat: {
...
export const NETWORKS = {
  confluxCore: {
    chainId: 1029,
    name: "Conflux Core",
    rpcUrl: process.env.CONFLUX_CORE_RPC_URL || "https://main.confluxrpc.com",
  },
  confluxCoreTestnet: {
    chainId: 1,
    name: "Conflux Core Testnet",
    rpcUrl: process.env.CONFLUX_CORE_TESTNET_RPC_URL || "https://test.confluxrpc.com",
  },
  hardhat: {
    chainId: 1337,
    name: "Hardhat Local",
...
export type ContractName = keyof typeof CONTRACT_ADDRESSES.confluxCore;
`;
